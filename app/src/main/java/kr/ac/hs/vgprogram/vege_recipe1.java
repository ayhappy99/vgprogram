...
public class vege_recipe1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vege_recipe1);
        ...
        mAdapter = new commentAdapter(commentList, vege_recipe1.this, email);
