...
public class egg_recipe1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egg_recipe1);
        ...
        mAdapter = new commentAdapter(commentList, egg_recipe1.this, email);
