...
public class fish_recipe1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new commentAdapter(commentList, fish_recipe1.this, email);

        mRecyclerView.setAdapter(mAdapter);

        FirebaseDatabase database =FirebaseDatabase.getInstance();
        myRef = database.getReference("fish_comment1");
//
...
////        myRef.setValue(comD);
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s){
                Log.i("fish_comment1",dataSnapshot.getValue().toString());

                commentData fish_comment1 = dataSnapshot.getValue(commentData.class);
                ((commentAdapter) mAdapter).addCom(fish_comment1);
